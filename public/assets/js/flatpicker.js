    ...
    function y(g, h) {
                    ...
                    window.requestAnimationFrame(function() {
                        if (
                            (void 0 !== D.calendarContainer &&
                                ((D.calendarContainer.style.visibility =
                                    "hidden"),
                            ...
                            (D.daysContainer.style.width = n + "px"),
                                (D.calendarContainer.style.width =
                                    ...
                                    (void 0 !== D.weekWrapper
                                        ...
                                        : 0) +
                                    "px"),
                                D.calendarContainer.style.removeProperty(
                                    "visibility"
                                ),
                                D.calendarContainer.style.removeProperty(
                                    "display"
            ...
            void 0 !== e &&
                ...
                (function(e) {
                    ...
                    void 0 !== D.amPM &&
                        ...
                        (D.amPM.textContent =
                            D.l10n.amPM[
                                r(D.amPM.textContent === D.l10n.amPM[0])
                            ]);
                    ...
                    if (void 0 !== a.value && 2 === a.value.length) {
                        ...
                        u < i
                            ...
                            : u > l &&
                              ((u =
                                  a === D.hourElement ? u - l - r(!D.amPM) : i),
                              g && Y(void 0, 1, D.hourElement)),
                            D.amPM &&
                                f &&
                                (1 === c
        ...
        function H(e, n, t, a) {
            ...
            return (
                ...
                o.setAttribute(
                    "aria-label",
                    D.formatDate(n, D.config.ariaDateFormat)
                ),
                -1 === e.indexOf("hidden") &&
                    0 === C(n, D.now) &&
                    ((D.todayDateElem = o),
                      ...
                      he(n) &&
                          ...
                          "range" === D.config.mode &&
                              (d(
                                  ...
                                  "startRange",
                                  D.selectedDates[0] &&
                                      0 === C(n, D.selectedDates[0], !0)
                              ),
                              d(
                                  o,
                                  "endRange",
                                  D.selectedDates[1] &&
                                      0 === C(n, D.selectedDates[1], !0)
                              ),
                              "nextMonthDay" === e &&
            ...
            if (
                ...
                for (var n = 0; n < 12; n++)
                    if (e(n)) {
                        ...
                        (t.value = new Date(D.currentYear, n)
                            .getMonth()
                            .toString()),
                            (t.textContent = p(
                                n,
            ...
            if (D.isOpen && !D.config.inline) {
                var n = m(e),
                    ...
                    a =
                        ...
                        (e.path &&
                            e.path.indexOf &&
                            (~e.path.indexOf(D.input) ||
                                ~e.path.indexOf(D.altInput))),
                    i =
                        "blur" === e.type
        ...
        function le(e) {
            if (void 0 !== D.calendarContainer) {
                ...
                if (
                    ...
                    if (
                        (d(D.calendarContainer, "rightMost", h),
                        !D.config.static)
                    )
                        if (((D.calendarContainer.style.top = u + "px"), h))
                            if (v) {
                                ...
                                (D.calendarContainer.style.left = "auto"),
                                    (D.calendarContainer.style.right =
                                        p + "px");
                        else
        ...
        function se(e) {
            ...
            if (void 0 !== n) {
                var t = n,
                    a = (D.latestSelectedDateObj = new Date(
                        t.dateObj.getTime()
                    )),
                    i =
                        (a.getMonth() < D.currentMonth ||
                            a.getMonth() >
                                D.currentMonth + D.config.showMonths - 1) &&
                        "range" !== D.config.mode;
            ...
            (D.close = function() {
                (D.isOpen = !1),
                    D.isMobile ||
                        ...
                        void 0 !== D._input &&
                            D._input.classList.remove("active"));
                ge("onClose");
            }),
            (D._createElement = s),
            (D.destroy = function() {
                ...
                (D.yearElements.forEach(function(e, n) {
                    ...
                    t.setMonth(D.currentMonth + n),
                        ...
                        "static" === D.config.monthSelectorType
                            ...
                            : (D.monthsDropdownContainer.value = t
                                  .getMonth()
                                  .toString()),
            ...
            (function() {
                (D.element = D.input = g),
                    ...
                    (function() {
                        var n = [
                            ...
                            i = e(
                                e(
                                    {},
                                    JSON.parse(JSON.stringify(g.dataset || {}))
                                ),
                                h
                            ),
                            o = {};
                    ...
                    (function() {
                        ...
                        D._positionElement =
                            D.config.positionElement || D._input;
                    })(),
                    (function() {
                        (D.selectedDates = []),
                        ...
                        void 0 !== D.config.minTime &&
                            (D.config.minTime = D.parseDate(
                                D.config.minTime,
                                "H:i"
                            ));
                        void 0 !== D.config.maxTime &&
                            (D.config.maxTime = D.parseDate(
                                D.config.maxTime,
                                "H:i"
                            ));
                        (D.minDateHasTime =
                            ...
                            if (
                                ...
                                if (
                                    (e.appendChild(
                                        ...
                                        (D.prevMonthNav.innerHTML =
                                            D.config.prevArrow),
                                        (D.nextMonthNav = s(
                                            "span",
                                            "flatpickr-next-month"
                                        )),
                                        (D.nextMonthNav.innerHTML =
                                            D.config.nextArrow),
                                        U(),
                            ...
                            D.config.enableTime &&
                                e.appendChild(
                                    (function() {
                                        ...
                                        (D.minuteElement = t.getElementsByTagName(
                                            "input"
                                        )[0]),
                                        ...
                                        if (D.config.enableSeconds) {
                                            ...
                                            (D.secondElement = a.getElementsByTagName(
                                                "input"
                                            )[0]),
                                ...
                                (D.mobileInput = s(
                                    ...
                                    (D.mobileFormatStr =
                                        "datetime-local" === e
                                            ...
                                            : "H:i:S"),
                                    D.selectedDates.length > 0 &&
                                        (D.mobileInput.defaultValue = D.mobileInput.value = D.formatDate(
                                            D.selectedDates[0],
                                            D.mobileFormatStr
                                        ));
                                D.config.minDate &&

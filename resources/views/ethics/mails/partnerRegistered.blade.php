                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Dear Sir/Madam,</h1>
                                        <p>
                                            Due diligence process has been carried out for the business partner
                                            {{$p->name}} for the project
                                            {{$p->ethics->contract}}. <br>

                                            The following are the outcomes of the process

                                            <ul>
                                                <li>The Business partner registration status is
                                                    <strong>{{$p->ethics->decisionVal($p->ethics->decision)}}</strong>
                                                </li>
                                            ...
                                            Business partner form and Business partner questionnaire are attached as
                                            reference.
                                        ...
                                        <p
                                            ...
                                            <a href="http://www.systra.com"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">www.systra.com</a>
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2020 Business Partner E &amp; C Portal. All rights reserved.</p>

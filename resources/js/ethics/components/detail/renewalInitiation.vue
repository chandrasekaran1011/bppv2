...
<div>
    ...
    <v-dialog v-model="renewInitiateDialog" fullscreen color="white" persistent transition="dialog-bottom-transition">
        <v-card>
            <v-toolbar dark color="primary">
                <v-btn icon dark @click="renewInitiateDialog = false">
                    <v-icon>fas fa-times</v-icon>
                </v-btn>
                <v-toolbar-title>Renew Business Partner</v-toolbar-title>

            </v-toolbar>

            <v-card class="mx-auto" color="white" elevation-3 width="100%" max-width="900px" min-width="600px" height="100%" min-height="400px">
                <div class="title grad text-left mt-3 pa-3">Renewal Form</div>

                <div class="title grad text-left pa-3 ">PART - A</div>
                ...
                <div class="title grad text-left pa-3 ">PART - C</div>
                ...
                <v-row :justify="'center'" class="mt-2  px-4 py-2" no-gutters>
                    <v-col cols="12" :md="6">
                        <div class="title1 text-left reqFields mt-3" for="name">Did the Business Partner breach one of its anticorruption commitments towards SYSTRA? </div>
                    </v-col>
                    <v-col cols="12" :md="6" class="pl-md-3">
...
export default {
    ...
    methods: {
        ...
        sumform() {
            ...
            axios.post(window.links.renew, formData, {
                headers: {
                ...
                this.renewInitiateDialog = false;
                this.$emit('reset');
            })
